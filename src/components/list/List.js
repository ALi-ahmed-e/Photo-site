...
const List = ({ mode }) => {
    ...
    return (
        <div className=' pb-48'>
            ...
            <div id='yes' onClick={(e) => fcsloss(e)} className={`z-10 fixed top-0 bottom-0 left-0 right-0 bg-glass flex  justify-center`} style={editpostl ? { 'display': 'flex' } : { 'display': 'none' }}>
